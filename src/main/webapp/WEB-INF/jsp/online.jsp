								...
								<div class="box-content">
									<form class="form-horizontal">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="corpName" placeholder="公司名字" id="corpName" class='input-square'>
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
												<input type="text" name="regCode" placeholder="注册号" id="regCode" class='input-square'>
